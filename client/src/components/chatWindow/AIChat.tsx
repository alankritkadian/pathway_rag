...
const messagesData = [
  { id: 1, content: 'How do we handle this deployment error?', isUser: true, userName: 'You', avatar: 'https://via.placeholder.com/150' },
  { id: 2, content: 'Try checking the server configurations.',  isUser: false, userName: 'Investment advisor ', avatar: '/invest.png' },
  { id: 3, content: 'I think there might be an issue with our CDN configuration.', isUser: true,  userName: 'You', avatar: 'https://via.placeholder.com/150' },
  { id: 4, content: "Yes, James is right. Let's check that as well.", isUser: false, userName: 'Budget Advisor', avatar: '/coin.png' },
  { id: 5, content: 'I think there might be an issue with our CDN configuration.',  isUser: false, userName: 'Stock analysor', avatar: '/stock.png' },

  { id: 6, content: 'Deployment error fixed. Good job, team!',  isUser: false, userName: 'News Updator', avatar: '/news.png' }
];
  ...
  return (
    <div className='flex flex-col w-[700px] border-transparent bg-white/20 backdrop-blur-lg rounded-lg mr-auto ml-5'>
      ...
      <div className='p-4 border-t-2 border-black flex items-center'>
        <input className='flex-grow p-2 mr-4 border-gray-500 rounded bg-black ' placeholder='Type your message here…' value={newMessage} onChange={(e) => setNewMessage(e.target.value)} onClick={(e) => sendMessage()} />
