...
export function NavigationMenuDemo() {
  return (
    <NavigationMenu>
      <NavigationMenuList>
        <NavigationMenuItem >
          <NavigationMenuTrigger className="bg-transparent backdrop-blur-md hover:backdrop-blur-lg hover:bg-transparent focus:backdrop-blur-lg focus:bg-transparent text-[#fefeff]">Getting started</NavigationMenuTrigger>
          <NavigationMenuContent >
        ...
        <NavigationMenuItem>
          <NavigationMenuTrigger className="bg-transparent backdrop-blur-md hover:backdrop-blur-lg hover:bg-transparent focus:backdrop-blur-lg focus:bg-transparent text-[#fefeff]">Components</NavigationMenuTrigger>
          <NavigationMenuContent>
